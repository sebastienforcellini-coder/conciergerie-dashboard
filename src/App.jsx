...
function PageWrapper({ children }) {
  ...
  return (
    <div key={location.pathname} style={{ animation: "fadeIn .18s ease-out" }}>
      {children}
    </div>
  );
}
...
export default function App() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", fontFamily: "'Inter', system-ui, sans-serif", background: "#f4f5f7" }}>

      <nav style={{
        width: 230, background: "#1a1a2e",
        ...
        <div style={{ height: 1, background: "#ffffff0e", margin: "0 16px" }} />
        ...
        <div style={{ padding: "14px 16px", display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            fontSize: 12, fontWeight: 600, color: "#ffffff80",
          }}>
            {propCount}
          </div>
          <div style={{ fontSize: 11, color: "#ffffff40", lineHeight: 1.4 }}>
            bien{propCount !== 1 ? "s" : ""}<br />
            <span style={{ color: "#ffffff25" }}>sous gestion</span>
          </div>
        </div>
      </nav>
